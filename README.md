...
* threshold value is the value to determine whether the website pairs are content drift or not. The pairs with similarity score below the threshold value will be marked as content drift.*
* The program uses selenium webdriver. One may needs to clean the tmp file created by the selenium if necessary.*
